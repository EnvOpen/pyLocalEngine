...
from localengine.core.exceptions import LocaleNotFoundError, LocaleFileError
...
def demo_caching_behavior():
    ...
    try:
        ...
        print(f"  Current locale cached: {engine.file_manager.is_locale_cached(engine.get_current_locale())}")
